...
//Title of your guestbook
  $title = "Technicians Notes for Choice International";
//Change "admin" with your own password. It's required when you delete an entry
  $admin_password = "8209";
//Enter your email here
  $admin_email = "support@techxel.com";
//Your website URL
  $home = "http://www.techxel.com";
   ...
   <td>
      ...
      <tr>
	    <td bgcolor="<?=$table_top?>" colspan="3" width="100%">
           <font size="2" color="#ffffff"><b> <a href="<?="$self?do=add_form&page=$page"?>">Add Entry</a> </font></b>
        </td>
	  </tr>
<?
			   ...
			   echo "<tr>
					   ...
					   <tr>
					    <td>
						   ...
						   <font size=\"2\"><b>Date: $row[2]</font>
						   
						   <font size=\"1\">Technician: $row[3]&nbsp;</font>
						   <font size=\"1\">Requested by: $row[6]&nbsp;</b></font><br>
						   <font size=\"1\">Time: $row[4]</font><br><br>
        ...
        <div align="center">
            <table width="100%" border="0" cellspacing="1" cellpadding="5">
              <tr bgcolor="<?=$table_content_1a?>"> 
                <td width="28%"> 
                  <div align="right"><font size="2">*Technician : </font></div>
                </td>
                <td width="72%"> 
              ...
              <tr bgcolor="<?=$table_content_1a?>"> 
                <td valign="top" width="28%"> 
                  <div align="right"><font size="2">*Comments : </font></div>
                </td>
                <td width="72%"> 
              ...
              <tr bgcolor="<?=$table_content_1a?>"> 
                ...
                <td width="72%"> 
				 ...
				 <!-- <img src="image.php?<?=time()?>" border="1"><br>-->
				  <input type="password" name="vsecc" size="10" maxlength="10">
                </td>
              </tr>
			  <?}?>
...
//		   input_err("Invalid URL format.");
 ...
 //  }
   ...
   if ($vsecc != 8209 && strtoupper($imgcode) == "YES") {
   ...
   if (!is_spam($newdata)) {
		...
		redir($self,"Sorry, your entry can't be added into the logs.");
	}
break;
