...
$locked = (!empty($_SESSION['lock_until']) && time() < $_SESSION['lock_until']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .eye-btn {
      ...
      padding: 0; font-size: 1.1rem; transition: color 0.2s;
    }
...
<div class="panel">
  ...
  <h2>Welcome Back</h2>
  <p class="subtitle">Enter your passcode to access ICS resources.</p>
  ...
  <form method="POST" action="index.php">
    ...
    <button type="submit" class="btn" <?= $locked ? 'disabled' : '' ?>>Unlock Portal</button>
  </form>
</div>
<script>
  function toggleEye() {
